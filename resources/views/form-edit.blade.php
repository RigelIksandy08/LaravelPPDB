            ...
            <div class="col-md-8">
                ...
                <form action="{{ url('/calonsiswa',['calonsiswa'=>$calonsiswa->id]) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('noppdb') is-invalid @enderror" type="text" name="noppdb" id="noppdb" value="{{ $calonsiswa->noppdb }}">
                        @error('noppdb')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('pilihan2') is-invalid @enderror" name="pilihan2" id="pilihan2">
                            <option selected="selected" value="{{ $calonsiswa->pilihan2 }}">{{ $calonsiswa->pilihan2 }}</option>
                            <option value="RPL">Rekayasa Perangkat Lunak</option>
                            <option value="TKJ">Teknik Komputer Dan Jaringan</option>
                            <option value="MM">Multimedia</option>
                            <option value="TEI">Teknik Elektronika Industri</option>
                    ...
                    <hr>
                    <button typse="submit" class="btn btn-primary">Daftar</button>
                </form>
            </div>
        </div>
    </div>
